...
describe Idna do
  it 'should pass toASCII_JOSEFSSON' do
    TESTCASES_JOSEFSSON.each do |key, val|
      rc = Idna.toASCII(val[0])
      val[1].downcase.should eq(rc)
    end
  end

  it 'should pass toASCII_UNASSIGNED_ALLOWED' do
  ...
  it 'should pass toUnicode_JOSEFSSON' do
    TESTCASES_JOSEFSSON.each do |key, val|
  ...
  it 'should pass toUnicode_STD3_NOT_USED' do
    TESTCASES_STD3.each do |key, val|
      rc = Idna.toUnicode(val[1])
      val[0].should eq(rc)
    end
